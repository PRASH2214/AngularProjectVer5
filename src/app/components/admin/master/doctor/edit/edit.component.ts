    ...
    this._route.params.subscribe(
      ...
      params => {
        ...
        this.sv.GetById(params["id"]).subscribe((m) => {
          ...
          this.onHospitalSelected(m.model.HospitalId);
          this.onBranchSelected(m.model.BranchId);
          ...
          if (m.model.MedicalLicenseImage != null && m.model.MedicalLicenseImage != undefined && m.model.MedicalLicenseImage != "") {
            this.imageshow = true;
